...
function wcuf_init_admin_panel()
{
	...
	add_submenu_page('woocommerce-files-upload', __('Cleaner','woocommerce-files-upload'), __('Cleaner','woocommerce-files-upload'), 'manage_woocommerce', 'wcuf-cleaner-page', 'render_wcuf_cleaner_page');
