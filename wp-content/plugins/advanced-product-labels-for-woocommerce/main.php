...
class BeRocket_products_label extends BeRocket_Framework {
    ...
    public $shortcodes = array(
        'br-wapl-label' => 'set_label_label',
        'br-wapl-image' => 'set_image_label',
        ...
        parent::admin_settings(
            ...
            'Advanced' => array(
                'shop_hook' => array(
                    ...
                    "label_for"=> __('Label\'s output on shop pages depends on the selected hook. Some themes might lack these hooks, or have them located differently from WooCommerce', 'BeRocket_products_label_domain'),
                    "name"     => "shop_hook",
                ...
                'product_hook_image' => array(
                    ...
                    "label_for"=> __('Label\'s output on a product page depends on the selected hook. Some themes might lack these hooks, or have them located differently from WooCommerce.', 'BeRocket_products_label_domain'),
