...
Customize your product fields: WooCommerce Extra Product Options plugin lets you add custom product fields(addons) to your product pages.

== Description ==
The WooCommerce Extra Product Options (WooCommerce Product Addons) plugin lets you add custom product fields(13 field types) and sections to your product page, making your WooCommerce product page more functional.
...
--------------------------------------------
https://www.youtube.com/watch?v=2sliqHsCqZw
--------------------------------------------

= ☞ Custom Product Fields =
Add advanced fields to the product page with Extra Product Options. 13 custom product fields help you to showcase a wider variety of products and options that work for almost every kind of WooCommerce store.
...
= ☞ More Features =
Apart from these wonderful features, WooCommerce Extra Product Options provides you with flawless useability. Listed some of them below;
...
You can check out the demo for a more detailed overview of the features. [Demo - Front End](https://flydemos.com/wepo/?utm_source=wordpress&utm_medium=referral&utm_content=tracking)  |  [Demo - Back End](https://flydemos.com/wepo/wp-admin/?utm_source=wordpress&utm_medium=referral&utm_content=tracking)
...
- **Percentage:** Set the addon price in percentage. The specificified percentage amount of the product price will be added to the product price.
...
--------------------------------------------
*For the complete list of features, Please visit [Extra Product Options (Product Addons) for WooCommerce](https://www.themehigh.com/product/woocommerce-extra-product-options/?utm_source=wordpress&utm_medium=referral&utm_content=tracking) plugin's official page.*

Check how it works (Live Demo): 🔗 [Front End](https://flydemos.com/wepo/?utm_source=wordpress&utm_medium=referral&utm_content=tracking)  |  🔗 [Back End](https://flydemos.com/wepo/wp-admin/?utm_source=wordpress&utm_medium=referral&utm_content=tracking)
--------------------------------------------
...
> domdeutz (@domdeutz) ⭐⭐⭐⭐⭐
> Guys are always available within seconds and provide **really valuable support**. Love it!
...
For more info on ThemeHigh and WooCommerce Extra Product Options (Product Addons) plugin in specific, check out the following:
...
2. Create custom field, 13 field types.
...
15. Field(s) display in product page.
16. Use html tags in field label.
