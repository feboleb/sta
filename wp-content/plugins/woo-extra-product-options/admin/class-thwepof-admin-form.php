...
abstract class THWEPOF_Admin_Form {
	...
	public function render_form_fragment_rules($type="field"){
		...
		<tr>
        	<td class="">
                Show if all below conditions are met.
            </td>
        </tr>
        <tr>                
            <td colspan="6">
	...
	public function render_field_form_fragment_product_list(){
        ...
        <select multiple="multiple" name="i_rule_value" data-placeholder="Click to select products" class="thwepof-enhanced-multi-select1 thwepof-operand thwepof-product-select" style="width:98%;" value="">
        </select>
        </div>
        <?php
	}
	...
	public function render_field_form_fragment_category_list(){		
		...
		if(!empty($categories)){
	        ...
	        <select multiple="multiple" name="i_rule_value" data-placeholder="Click to select categories" class="thwepof-enhanced-multi-select thwepo-operand" style="width:98%;" value="">
				<?php 	
	...
	public function render_field_form_fragment_tag_list(){		
		...
		if(!empty($tags)){
	        ...
	        <select multiple="multiple" name="i_rule_value" data-placeholder="Click to select tags" class="thwepof-enhanced-multi-select thwepo-operand" style="width:98%;" value="">
				<?php 	
	                foreach($tags as $tag){
