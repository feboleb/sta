...
= 2.0.1 - Released on 30 July 2020 = 

* Fix: Custom icons don't load the custom icons
* Fix: Custom icons don't load the correct image sizes
* Fix: Live validation issue if billing and shipping step is merged
* Fix: Live validation for extra fields added with YITH WooCommerce Checkout Manager
* Dev: yith_wcms_plugin_enabled_on_front filter to enable or disable the plugin on frontend programmatically
